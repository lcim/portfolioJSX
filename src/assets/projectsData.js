export const projectsData = [
    {
        ...
        imageUrl: 'https://i.postimg.cc/8kq4SpXr/nameit.png',
        projectUrl: 'https://lcim.github.io/name-finder/',
        visitProject: "https://lcim.github.io/name-finder/" ,
    },
    {
        ...
        imageUrl: 'https://i.postimg.cc/2Sx7h4k4/flashtyper.png',
        projectUrl: 'https://lcim.github.io/flash-typer/',
        visitProject: "https://lcim.github.io/flash-typer/" ,
    },
    {
        projectName: 'PokeDex',
        projectDescription:
            "Pokemon used to be a huge part of childhood, wasn't it? Talking about pokemon brings back so many memories, but do you remember the details of each pokemon? Probably No! So here I bring you a pokedex to check all pokemons :)",
    ...
    },
    {
        ...
        imageUrl: 'https://i.postimg.cc/7ZXfqXch/portfolio.png',
        projectUrl: 'https://lcim.github.io/portfolioJSX/#/',
        visitProject: "https://lcim.github.io/portfolioJSX/#/" ,
    },
    {
        projectName: 'Digital Biz Card',
        projectDescription:
